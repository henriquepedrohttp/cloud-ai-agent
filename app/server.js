...
const STOP_WORDS = [
  ...
  'cuidado', 'atencao', 'atencão', 'alerta', 'aviso', 'nota',
  'observacao', 'observação', 'importante', 'urgente',
  'critico', 'crítico', 'prioridade', 'bloqueador', 'bloqueio',
  'dependencia', 'dependência', 'dependencias',
  'incompatibilidade', 'conflito', 'merge',
